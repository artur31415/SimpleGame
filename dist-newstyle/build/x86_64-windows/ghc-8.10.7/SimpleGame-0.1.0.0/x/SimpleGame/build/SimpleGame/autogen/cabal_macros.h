...
/* package SimpleGame-0.1.0.0 */
#ifndef VERSION_SimpleGame
#define VERSION_SimpleGame "0.1.0.0"
#endif /* VERSION_SimpleGame */
#ifndef MIN_VERSION_SimpleGame
#define MIN_VERSION_SimpleGame(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_SimpleGame */
...
#define CURRENT_COMPONENT_ID "SimpleGame-0.1.0.0-inplace-SimpleGame"
